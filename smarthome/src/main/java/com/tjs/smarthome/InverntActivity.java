...
public class InverntActivity extends BaseActivity implements View.OnClickListener {
    private ImageButton setting_title_ib;
    private TextView setting_toolbar_tv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_invernt);
        initView();
    }
    ...
    public void initView() {
        ...
        setting_toolbar_tv.setText("虚拟设备");
